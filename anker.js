            ...
            if (bad.includes(messagesC)) {
                if (!isGroupAdmins) {
                    try {
                        ...
                        setTimeout( () => {
 	                           dms.groupRemove(from, [kickk]).catch((e)=>{reply(`*ERR:* ${e}`)})
 					   	}, 5000)
								setTimeout( () => {
								dms.updatePresence(from, Presence.composing)
								reply("1detik")
                        ...
                        } catch { dms.sendMessage(from, `Untung cya bukan admin, kalo admin udah cya kick!`, text , {quoted : mek}) }
                } else {
...
┣⊱ *Youtube* : *${yt}*
┣⊱ *Instagram* : *${instagram}*
┣⊱ *Owner/Pembuat Bot* : *wa.me/6281367646011?text=Hallo+Owner+Gans*
┬
╰────────────────────────
...
╰────────────────────────
                `
                todj = await getBuffer(`https://i.ibb.co/CKnYDXC/IMG-20210313-WA0018.jpg`)
                dms.sendMessage(from, todj, image, { quoted : mek, caption: `${menunye}`, text,  quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "Subscribe Channel Anker Production", 'jpegThumbnail': fs.readFileSync('./sticker/menu.webp')}}}})
    				break 
    			case prefix+'infobot':
			...
			//if (!isPublic) return reply(mess.only.publikG)
                ...
                menunyeq = `
╔════════════════════❤︎
┣❥︎ *No Gopay : 081368646011*
┣❥︎ *No Pulsa : 081368646011*
┣❥︎ *No Dana : 081368646011*
┣❥︎ *No Ovo : 082240069301*
┣❥︎ *Saweria : saweria.co/darkbot2412*
╚════════════════════❤︎
                `
                todjq = await getBuffer(`https://i.ibb.co/CKnYDXC/IMG-20210313-WA0018.jpg`)
                dms.sendMessage(from, todjq, image, { quoted : mek, caption: `${menunyeq}`, text,  quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "Subscribe Channel Anker Production", 'jpegThumbnail': fs.readFileSync('./sticker/menu.webp')}}}})
    				break 
				case prefix+'info':
					me = dms.user
					user.push(sender)
                ...
                if (!isGroupAdmins) return reply(ind.admin())
                if (args.length < 1) return reply('*Ketik #badword enable untuk menyalakan, #badword disable untuk mematikan!!!*')
                if (args[0] === 'enable') {
            ...
            break  
				...
				case prefix+'owner':
                 ...
                 dms.sendMessage(from, 'Dia Adalah Pembuat Bot Ini, Jangan Lupa Di Save',text, { quoted: mek} )
                 break
                case prefix+'fitnah':
                 if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
         ...
         case prefix+'lirik':
			    ...
			    case prefix+'nsfwneko':
					...
					await limitAdd(sender) 
					break 
				case prefix+'emojipng':
               iniss = `${body.slice(10)}`
				anusj = await getBuffer(`https://api.zeks.xyz/api/emoji-image?apikey=apivinz&emoji=${encodeURIComponent(iniss)}`, {method: 'get'})
				dms.sendMessage(from, anusj, image,{quoted : mek, caption : 'DONE'})
				break
...
//creator
				case prefix+'attp':
		               ...
		               dms.sendMessage(from, atetepeq, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "Subscribe Channel Anker Production", 'jpegThumbnail': fs.readFileSync('./sticker/anker.webp')}}}})
		               break
               case prefix+'ttp':
		               if (args.length < 1) return reply('Textnya mana ?')
		               const iniq = body.slice(5)
		               const atetepeq = await getBuffer(`https://api.xteam.xyz/ttp?file&text=${encodeURIComponent(iniq)}`)
		               dms.sendMessage(from, atetepeq, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "Subscribe Channel Anker Production", 'jpegThumbnail': fs.readFileSync('./sticker/anker.webp')}}}})
		               break
...
//akhir kreator
		    ...
		    case prefix+'map':
				...
				case prefix+'kicktime':
					...
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					setTimeout( () => {
					dms.sendMessage(from, 'Yg Gw Kick Jan Balek Lagi Ajg:v', text)
					}, 12000)
					setTimeout( () => {
					dms.sendMessage(from, `Mampus Ajg`, text) // ur cods
					}, 11000)
					setTimeout( () => {
					dms.groupRemove(from, mentioned)
					}, 10000)
					setTimeout( () => {
					dms.sendMessage(from, `10`, text) // ur cods
					}, 9000)
					setTimeout( () => {
					dms.sendMessage(from, `9`, text) // ur cods
					}, 8000)
					setTimeout( () => {
					dms.sendMessage(from, `8`, text) // ur cods
					}, 7000)
					setTimeout( () => {
					dms.sendMessage(from, `7`, text) // ur cods
					}, 6000)
					setTimeout( () => {
					dms.sendMessage(from, `6`, text) // ur cods
					}, 5000)
					setTimeout( () => {
					dms.sendMessage(from, `5`, text) // ur cods
					}, 4000)
					setTimeout( () => {
					dms.sendMessage(from, `4`, text) // ur cods
					}, 3000)
					setTimeout( () => {
					dms.sendMessage(from, `3`, text) // ur cods
					}, 2000)
					setTimeout( () => {
					dms.sendMessage(from, `2`, text)
					}, 1000)
					setTimeout( () => {
					dms.sendMessage(from, `1`, text)
					}, 0)
					break
                case prefix+'darkgroup':
		case prefix+'darkgrup':
					reply('*Link Group1 : https://chat.whatsapp.com/G8Lb8t0qG0iLFLxOCPY5hb*\n*Link Group2 : https://chat.whatsapp.com/ESjfmdhnvazG6X6hHFevAF*')
					break 
				case prefix+'promote':
				case prefix+'pm':
				if (isBanned) return reply(mess.only.benned)    
